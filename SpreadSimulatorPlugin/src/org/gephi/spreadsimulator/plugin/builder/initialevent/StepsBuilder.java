...
import org.gephi.spreadsimulator.plugin.initialevent.*;
...
public class StepsBuilder implements InitialEventBuilder {
	@Override
	public String getName() {
		return NbBundle.getMessage(Steps.class, "Steps.name");
	}

	@Override
	public InitialEvent getInitialEvent(String params) {
		return new Steps(Integer.parseInt(params));
	}
