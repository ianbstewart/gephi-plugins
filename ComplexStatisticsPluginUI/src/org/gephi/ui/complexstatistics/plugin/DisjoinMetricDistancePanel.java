 ...
 */
public class DisjoinMetricDistancePanel extends javax.swing.JPanel {

    /** Creates new form DisjoinMetricDistancePanel */
    public DisjoinMetricDistancePanel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        header.setDescription(org.openide.util.NbBundle.getMessage(DisjoinMetricDistancePanel.class, "DisjoinMetricDistancePanel.header.description")); // NOI18N
        header.setTitle(org.openide.util.NbBundle.getMessage(DisjoinMetricDistancePanel.class, "DisjoinMetricDistancePanel.header.title")); // NOI18N

        directedButtonGroup.add(undirectedRadioButton);
        undirectedRadioButton.setText(org.openide.util.NbBundle.getMessage(DisjoinMetricDistancePanel.class, "DisjoinMetricDistancePanel.undirectedRadioButton.text")); // NOI18N

        directedButtonGroup.add(directedRadioButton);
        directedRadioButton.setText(org.openide.util.NbBundle.getMessage(DisjoinMetricDistancePanel.class, "DisjoinMetricDistancePanel.directedRadioButton.text")); // NOI18N
